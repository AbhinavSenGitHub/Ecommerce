...
import { fetchAllProductsAsync, fetchBrandsAsync, fetchCategoriesAsync, fetchProductsByFiltersAsync, selectAllBrands, selectAllCategories, selectAllProducts, selectTotalItems } from '../productSlice';
...
export default function ProductList() {
  ...
  const handleFilter = (e, section, option) => {
    const newFilter = { ...filter }   //The spread syntax (...) is used to create a shallow copy of an object or an array in JavaScript.
    if (e.target.checked) {
  ...
  // dispatch for categories and brands
  useEffect(()=>{
